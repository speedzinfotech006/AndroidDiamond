...
public class NewSearchResultActivity extends BaseDrawerActivity {

    ImageView imgMenu, imgOMenu, imgViewCount, imgLayout, imgSearch;
    LinearLayout llPlus, llViewCount, llModify, llCart, llHorizontal, llPlaceOrder, llDownload, llEmailStone;
    ...
    Context context = NewSearchResultActivity.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getLayoutInflater().inflate(R.layout.activity_new_search_result, frameLayout);

        Log.e("Activity Open ","New Search Activity");
                    ...
                    if (etSearch.getCompoundDrawables()[2] != null) {
                        if (event.getRawX() >= (etSearch.getRight() - etSearch.getCompoundDrawables()[2].getBounds().width())) {
                            if (Const.isEmpty(etSearch)) {
                                ...
                                Const.hideSoftKeyboard(NewSearchResultActivity.this);
                                etSearch.clearFocus();
                            } else {
                                etSearch.setText("");
                            }
...
//                Debug.e(TAG, t.getLocalizedMessage());
    ...
    private BroadcastReceiver onDownloadComplete = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (downID == id) {
                ...
                share.setAction(Intent.ACTION_SEND);
                share.setType("application/vnd.ms-excel");
                Uri uri = FileProvider.getUriForFile(NewSearchResultActivity.this, BuildConfig.APPLICATION_ID + ".provider",file);
                share.putExtra(Intent.EXTRA_STREAM, uri);
                share.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                StrictMode.VmPolicy.Builder builder = new StrictMode.VmPolicy.Builder();
                StrictMode.setVmPolicy(builder.build());
    ...
    private void shareDialog() {
        ...
        final LinearLayout llExcel = dialog.findViewById(R.id.llExcel);
        final LinearLayout llDetails = dialog.findViewById(R.id.llDetails);
        final LinearLayout llImages = dialog.findViewById(R.id.llImages);
        final LinearLayout llVideo = dialog.findViewById(R.id.llVideo);
        final LinearLayout llCerti = dialog.findViewById(R.id.llCerti);
                    ...
                    for (int j = 0; j < list.size(); j++) {
                        if (list.get(j).get("isoverseas").equalsIgnoreCase("0")) {
                            if (list.get(j).get("bimage").equalsIgnoreCase("true")) {
                                if (list.get(j).get("image_url") != null) {
...
//                        public void onMenuToggle(boolean opened) {
//                            if (opened) {
//                                rvList.setBackgroundColor(Color.LTGRAY);
//                            } else {
//                                rvList.setBackgroundColor(Color.TRANSPARENT);
//                            }
//                        }
//                    });
...
//                    h.tvColor.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
...
//                    });
//
//                    h.tvCPS.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
//                            h.llClick.performClick();
//                        }
//                    });
//
//                    h.tvFls.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
//                            h.llClick.performClick();
//                        }
//                    });
//
//                    h.tvBgm.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
//                            h.llClick.performClick();
//                        }
//                    });
//
//                    h.tvClarity.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
...
//                    });
//
//                    h.tvCts.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
//                            Const.hmStoneDetail = map;
//                            startActivity(new Intent(context, StoneDetailActivity.class));
...
//                    });
//
//                    h.tvStatus.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
//                            Const.hmStoneDetail = map;
//                            startActivity(new Intent(context, StoneDetailActivity.class));
